...
import com.epicode.GodfathersPizza.repository.IOrdineDAOrepository;
...
public class OrdineService {
	...
	private final IOrdineDAOrepository ordineDAO;

    @Autowired
    public OrdineService(@Qualifier("ordineDAOrepositoryImpl")IOrdineDAOrepository ordineDAO) {
